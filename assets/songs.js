...
import {listChart,cpopList,lunarnewyearList,usukList,jpopList} from './chart.js';
...
const YourLibrary = {
    ...
    isRandom: false,
    isRepeat: false,
    songs: [listChart,listChart,listChart,listChart,listChart,listChart,listChart,listChart,cpopList,usukList,listChart,lunarnewyearList,listChart,listChart,listChart,jpopList,listChart,listChart,listChart],
...
const KindListen = {
    currentIndex: 0,
    songs: [listChart,listChart,listChart,listChart,listChart,listChart,listChart,cpopList,usukList,listChart,lunarnewyearList,listChart,listChart,listChart,jpopList,listChart,listChart,listChart],
    render: function(){
        var html=[];
